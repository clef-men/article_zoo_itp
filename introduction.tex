...
Although \HeapLang is theoretically expressive enough to represent \OCaml programs, our experience showed that it is fairly impractical when it comes to verifying large \OCaml libraries.
